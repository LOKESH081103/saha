...
with col_chola:
    ...
    # Top-up Details & Principal Contribution - kept functional, tucked out of the main clean view
    with st.expander("Top-up Details & Principal Contribution", expanded=False):
