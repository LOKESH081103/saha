...
with col_chola:
  with st.container(key="chola_card"):
    ...
    # Top-up Details & Principal Contribution - inside the Chola card, always visible (no dropdown)
    with st.container(border=True):
        st.markdown('<div class="inner-title" style="font-size: 15px;">Top-up Details &amp; Principal Contribution</div>', unsafe_allow_html=True)
